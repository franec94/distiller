% -------------------------------------------------------------------------------- %
% Latex file: `selected-compression-techs.tex`
% Description:
% Speaing about Selected Pruning Techniques
% -------------------------------------------------------------------------------- %


% Introduction Slides that presents what kind of topic the current
% section will go to treat:
% Selected Deep Nets Compression Techniques
% -------------------------------------------------------------------------------- %
\begin{frame}
